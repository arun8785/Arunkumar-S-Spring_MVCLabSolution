...
<body>
	...
	<div class="container">
		...
		<form action="/StudentRegistrationPortal/students/search" class="form-inline">

			<!-- Add a button -->
			<a href="/StudentRegistrationPortal/students/showFormForAdd"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/StudentRegistrationPortal/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/StudentRegistrationPortal/students/delete?studentId=${tempStudent.id}"
